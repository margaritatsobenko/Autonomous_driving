...
if("TRUE" STREQUAL "TRUE")
  set(laser_scan_SOURCE_PREFIX /home/nikolay/HW_2/src/laser_scan)
  set(laser_scan_DEVEL_PREFIX /home/nikolay/HW_2/devel)
  ...
  set(laser_scan_INSTALL_PREFIX /home/nikolay/HW_2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_scan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nikolay/HW_2/src/laser_scan/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT laser_scan_NUM_DUMMY_TARGETS)
      set(laser_scan_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::laser_scan::wrapped-linker-option${laser_scan_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR laser_scan_NUM_DUMMY_TARGETS "${laser_scan_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::laser_scan::wrapped-linker-option${laser_scan_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND laser_scan_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nikolay/HW_2/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(laser_scan_EXPORTED_TARGETS ${${laser_scan_dep}_EXPORTED_TARGETS})
endforeach()
